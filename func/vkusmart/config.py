...
##### change weights folder
config.DIRS.WEIGHTS_ROOT = Path('/mnt/nfs/weights/').resolve()
...
config.DETECTOR.FRAMEWORK = 'pytorch'  # ['tf', 'pytorch']
...
config.REID.WEIGHTS_PATH = config.DIRS.WEIGHTS_ROOT/'reids/model.pth.tar-50'
...
config.POSEMODEL.HM_WEIGHTS_PATH = config.DIRS.WEIGHTS_ROOT/'poses/pose_resnet_50_256x192.pth.tar'
...
config.ARMSTATE.WEIGHTS_PATH = config.DIRS.WEIGHTS_ROOT/'armstate/armstate_v8.1_both_rot_mergeV7_efficientnet-b0_unfrozen_complicated_ptd_0.912.pth'
